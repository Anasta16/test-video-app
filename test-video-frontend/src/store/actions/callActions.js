...
export const CALL_SET_CALLING_DIALOGUE_VISIBLE = 'CALL.SET_CALLING_DIALOGUE_VISIBLE';
export const CALL_SET_CALLER_USERNAME = 'CALL_.SET_CALLER_USERNAME';
...
export const setCallingDialogueVisible = (visible) => {
    return {
